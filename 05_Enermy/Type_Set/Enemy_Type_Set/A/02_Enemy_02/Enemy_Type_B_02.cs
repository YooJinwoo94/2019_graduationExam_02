...
public class Enemy_Type_B_02 : MonoBehaviour {
    ...
    IEnumerator Move_Type_Enemy()
    {
        ...
        //  transform.position = Vector3.Lerp(transform.position, Player_Pos.transform.position, 0.01f);
        /*
        Vector3 velo = Vector3.zero;
        transform.position = Vector3.SmoothDamp(transform.position, Player_Pos.transform.position, ref velo, 0.1f);
        */
